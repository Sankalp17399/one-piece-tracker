...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#180e09] text-[#f4e6cc] font-serif select-none pb-24 md:pb-12 bg-[radial-gradient(#8b5a2b_0.75px,transparent_0.75px)] [background-size:16px_16px]">
      ...
      {/* Tactile Skeuomorphic Wood Header */}
          ...
          <div className="hidden md:flex items-center bg-[#150c07] p-1 rounded-xl border border-[#8b5a2b]/40 text-xs shadow-inner">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg font-bold transition-all ${
                activeTab === 'dashboard' ? 'bg-[#8b5a2b] text-[#f7eedc] shadow-sm' : 'text-[#b89574] hover:text-[#f3e5c8]'
              }`}
            >
              Voyage
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-lg font-bold transition-all ${
                activeTab === 'guide' ? 'bg-[#8b5a2b] text-[#f7eedc] shadow-sm' : 'text-[#b89574] hover:text-[#f3e5c8]'
              }`}
            >
              Logbook
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-lg font-bold transition-all ${
                activeTab === 'profile' ? 'bg-[#8b5a2b] text-[#f7eedc] shadow-sm' : 'text-[#b89574] hover:text-[#f3e5c8]'
              }`}
            >
              Bounty & Nakama
            </button>
          ...
          <div className="space-y-4 animate-in fade-in duration-150">
            ...
            <div className="bg-[#f3e5c8] border-[3px] border-[#9c6a3b]/80 rounded-2xl p-3.5 space-y-2.5 text-[#341d10] shadow-[0_8px_20px_rgba(0,0,0,0.4)]">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-8 pr-3 py-1.5 bg-[#e8d5b3] border border-[#8b5a2b]/60 rounded-xl text-xs text-[#2b1407] placeholder-[#704b2b]/70 focus:outline-none shadow-inner"
                />
              </div>
            ...
            <div className="space-y-2">
              {filteredItems.map((item) => {
                const isCompleted = completedIds.has(item.id);<dyad-write path="src/pages/Index.tsx" description="Complete Index page with elegant minimalist skeuomorphism, parchment logbook, and tactile Nakama roster">
"use client";
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0 font-sans">
                        {item.type === 'canon' ? (
                          <span className="text-[10px] font-bold text-emerald-800 bg-emerald-700/15 px-2 py-0.5 rounded border border-emerald-700/30">Canon</span>
                        ) : item.skipStatus === 'worth-watching' ? (
                          <span className="text-[10px] font-bold text-amber-900 bg-amber-700/20 px-2 py-0.5 rounded border border-amber-700/30">G-8 Masterpiece</span>
                        ) : (
                          <span className="text-[10px] font-bold text-rose-800 bg-rose-700/15 px-2 py-0.5 rounded border border-rose-700/30">Skip</span>
                        )}
                        ...
                        {isExpanded ? <ChevronUp size={14} className="text-[#704b2b]" /> : <ChevronDown size={14} className="text-[#704b2b]" />}
                      </div>
                    </div>
          ...
          <div className="space-y-5 animate-in fade-in duration-150">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
              ...
              <div className="space-y-4">
                {/* Tactile Crew Roster Ledger Card */}
                ...
                {/* Tactile Sea Journal Backup Ledger */}
